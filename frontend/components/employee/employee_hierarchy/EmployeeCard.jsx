  ...
  const cardClasses = `
    flex flex-col rounded-xl p-4 md:p-6 bg-white border ${
      isLeadership
        ...
        ? "border-blue-200"
        : "border-gray-200"
    } ${isLeadership ? "shadow-sm" : ""}
    ${isDepartmentHead ? "max-w-md w-full" : "w-full"}
  `;
    ...
    <div className={cardClasses}>
      <div className="flex items-center gap-x-4">
        ...
        <div className="grow">
          ...
          <p className="text-xs uppercase text-gray-500">{employee.role}</p>
        </div>
      </div>

      <p className="mt-3 text-gray-500">{employee.bio}</p>
